...
enet = ENET(256, 256, classes)
print(enet.output_shape)
try:
    print('Loading previous weights')
    enet.load_weights('enet.h5')
except:
    print('Training from scratch !!!')
p_enet = multi_gpu_model(enet, 4)
p_enet.compile(optimizer='adam', loss='sparse_categorical_crossentropy', metrics=['mse','accuracy'])
...
p_enet.fit_generator(train_gen, steps_per_epoch=steps, epochs=10, callbacks=callbacks, workers=8)
print('Saving final weights')
enet.save_weights('enet_model/enet.h5')
